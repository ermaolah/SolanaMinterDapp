...
const SOL_MINT_NFT_PROGRAM_ID = new anchor.web3.PublicKey(
  "5gbdGVHSDyRTMUoyhbRWNDTcGV2Hf7SMqv8nb5Y1kg5T"
);
...
// const projectId = "2EZSyqieUghRtxZO4AUJcdO1cSo"; //(Step 3. Place the project id from your infura project)
// const projectSecret = "5303c5d1acc3b238f46aeb98276d9b00"; //(Step 4. Place the project_secrect from your infura project)
...
const Minter = () => {
  ...
  const uploadImageToIpfs = async () => {
    ...
    return `https://infura-ipfs.io/ipfs/${uploadedImage.path}`;
  };
  ...
  const uploadMetadataToIpfs = async (
    ...
    if (uploadedMetadata == null) {
      ...
      return `https://infura-ipfs.io/ipfs/${uploadedMetadata.path}`;
    }
  };
  ...
  return (
    <Row style={{ margin: 60 }} className="fm" >
      {minting && (
